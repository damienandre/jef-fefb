...
<form method="POST" action="/admin/add-stage">
    ...
    <div class="form-group">
        ...
        <input type="text" name="name" id="name" maxlength="200" required>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" name="organizer" id="organizer" maxlength="200">
    </div>
    ...
    <div class="form-group">
        ...
        <input type="url" name="info_url" id="info_url" maxlength="500" placeholder="https://...">
    </div>

    <div class="form-group">
        <label for="registration_url">URL d'inscription</label>
        <input type="url" name="registration_url" id="registration_url" maxlength="500" placeholder="https://...">
    </div>
